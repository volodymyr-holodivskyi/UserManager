...
export class HttpService {
  ...
  getUsers(page: number = 0, pageSize: number = 0): Observable<User[]> {
    ...
    return this.http
      .get('http://127.0.0.1:3000/api/v1/users', { params, headers })
      .pipe(
        map((data: any) => {
          let userList = data;
  ...
  getUsersCount(): Observable<number> {
    ...
    return this.http
      .get('http://127.0.0.1:3000/api/v1/count', { headers })
      .pipe(
        map((data: any) => {
          return data;
        })
  ...
  getUser(id: number): Observable<User> {
    ...
    return this.http
      .get(`http://127.0.0.1:3000/api/v1/users/${id}`, { params, headers })
      .pipe(
        map((data: any) => {
          let user = data;
          return new User(
  ...
  editUser(data: User) {
    ...
    return this.http.put(`http://127.0.0.1:3000/api/v1/users/`, body, {
      params,
      headers,
    });
  }
